...
<nav class="navbar navbar-default navbar-fixed-top navbar-inverse" role="navigation">
  ...
  <div class="container">
   ...
   <div class="panel-body">
     <form role="form" enctype="multipart/form-data" method="post" action="<?php echo U('Admin/UpdateDiary/Update');?>">
       <div class="form-group">
         <label for="id">ID</label>
         <input type="text" class="form-control" id="id" name="id" required="required" value="<?php echo ($diary_info['id']); ?>">
       </div>    
       <div class="form-group">
         <label for="title">标题</label>
         <input type="text" class="form-control" id="title" name="title" placeholder="请输入标题" required="required" value="<?php echo ($diary_info['title']); ?>">
       </div>
       <div class="form-group">
         <label for="content">随笔内容</label>
         <input type="text" class="form-control" id="content" name="content" placeholder="请输入简介" required="required" value="<?php echo ($diary_info['content']); ?>">
       </div>
