   ...
   <div class="col-xs-12 col-sm-8 col-md-8">
    <div class="panel panel-default">
      <div class="panel-heading">
        <p class="h4"> <span class="glyphicon glyphicon-leaf"></span>&nbsp随笔</p>
      </div>
      <div class="panel-body">
       <div class="row">
        <?php if(is_array($diary_info)): $i = 0; $__LIST__ = $diary_info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="col-xs-12 col-sm-4 col-md-4">
             <div class="well diary-well">
              <p class="h5"><span class="glyphicon glyphicon-paperclip"></span>&nbsp<?php echo ($vo["title"]); ?></p>
              <div class="diary-content">
              <?php echo ($vo["content"]); ?>
              </div>
              <p class="text-right"><span class="glyphicon glyphicon-time"></span>&nbsp<?php echo ($vo["create_time"]); ?></p>
             </div>
