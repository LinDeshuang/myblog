  ...
  <div class="row">
   <div class="col-xs-12 col-sm-8 col-md-8">
     <div class="panel panel-default">
          ...
          <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="col-xs-12 col-sm-4 col-md-4">    
            <div class="panel panel-success panel-comment">
             <div class="panel panel-heading">
              <span class="glyphicon glyphicon-user"></span>&nbsp<?php echo ($vo["nickname"]); ?>
              <span class="glyphicon glyphicon-time"></span>&nbsp<?php echo ($vo["com_time"]); ?>
             </div>
             <div class="panel-body text-left">
              ...
              <div class="answer">
                ...
                <div class="content text-left text-justify text_p">
                 <?php if($vo["answer"] == NULL): ?>暂未回复
                  <?php else: ?> <?php echo ($vo["answer"]); endif; ?>
                </div>
              </div>
            </div>
        ...
        <div class="panel-footer text-right"><?php echo ($page); ?></div>
    </div>
  </div>
