...
<div class="container">
  <div class="row">
   <div class="col-xs-12 col-sm-8 col-md-8">
    <div class="well">
      <?php if(is_array($cate_info)): $i = 0; $__LIST__ = $cate_info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate_info): $mod = ($i % 2 );++$i;?><div class="row">
          <div class="col-xs-2 col-sm-2 col-md-2 thumbnail">
            <img title="<?php echo ($cate_info['name']); ?>" src="/myblog/Public/Uploads/<?php echo ($cate_info['img_path']); echo ($cate_info['img_name']); ?>">
          </div>
          <div class="col-xs-10 col-sm-10 col-md-10">
           <p><h1><?php echo ($cate_info['name']); ?></h1><small class="text-muted">（以下都是关于<?php echo ($cate_info['name']); ?>的文章）</small></p>
          </div>
        </div><?php endforeach; endif; else: echo "" ;endif; ?>    
    </div>

     <div class="row">
       <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="col-xs-12 col-sm-4 col-md-4">
          <div class="well well-pb">
           <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 thumbnail well-img">
              <a href="<?php echo U('Home/Article/index',array('id'=>$vo['id']));?>">
                <img  src="/myblog/Public/Uploads/<?php echo ($vo["img_path"]); echo ($vo["img_name"]); ?>" title="<?php echo ($vo["title"]); ?>">
              </a>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                   
             <p class="well-title h4 text-center"><span class="text-info">[<?php echo ($vo["type"]); ?>]</span><a href="<?php echo U('Home/Article/index',array('id'=>$vo['id']));?>"><?php echo ($vo["title"]); ?></a></p>
                   
             <p class="well-intro text-muted text-p"><?php echo ($vo["intro"]); ?></p>
             <div class="well-footer text-center">
              <span class="glyphicon glyphicon-time"></span><?php echo ($vo["create_time"]); ?>
              <span class="glyphicon glyphicon-comment"></span><?php echo ($vo["comment_sum"]); ?>
              <span class="glyphicon glyphicon-tag"></span><?php echo ($vo["category"]); ?>
               <a class="btn btn-info" href="<?php echo U('Home/Article/index',array('id'=>$vo['id']));?>">MORE</a>
             </div>
            </div>
           </div>
          </div>
        ...
        <div class="well-page text-center"><?php echo ($page); ?></div>
    </div>  
 ...
 <footer>
  ...
  <p>Power By <a href="www.thinkphp.cn">Thinkphp</a>&<a href="getboostrap.com">Bootstrap</a></p>
