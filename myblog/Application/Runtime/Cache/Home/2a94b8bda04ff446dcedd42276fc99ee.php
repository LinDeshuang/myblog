...
<html>
   <head>
      ...
      <script type="text/javascript" src="/myblog/Public/js/index.js"></script>
   ...
   <div class="banner-row">
     <div class='banner'>
      <div class="text-center">
       ...
       <p class="h4">——欢迎！</p>
       <p class="h3">Today is <?php echo ($time); ?></p>
  ...
  <div class="row">
   <div class="col-xs-12 col-sm-9 col-md-9">
    <div class="well well-head">
     ...
     <div class="row">
       <?php if(is_array($article_info)): $i = 0; $__LIST__ = $article_info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="col-xs-12 col-sm-4 col-md-4">
           ...
           <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
             ...
             <div class="well-footer text-center">
              <span class="glyphicon glyphicon-time"></span> &nbsp<?php echo ($vo["create_time"]); ?>
              <span class="glyphicon glyphicon-eye-open"></span> &nbsp<?php echo ($vo["click_sum"]); ?>
              <span class="glyphicon glyphicon-tag"></span> &nbsp<?php echo ($vo["category"]); ?>
               <a class="btn btn-default" href="<?php echo U('Home/Article/index',array('id'=>$vo['id']));?>" data-toggle="tooltip" title="查看详情">MORE</a>
             </div>
            </div>
           </div>
          </div>
